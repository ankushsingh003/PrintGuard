...
def get_data_loaders(data_dir, batch_size=32, train_split=0.8, img_size=(224, 224), subset_fraction=1.0):
    ...
    if subset_fraction < 1.0:
        ...
        base_dataset = Subset(base_dataset, indices[:num_subset])
    ...
    train_dataset = QualityDataset(Subset(base_dataset, train_indices), transform=train_transforms)
    val_dataset = QualityDataset(Subset(base_dataset, val_indices), transform=val_transforms)
